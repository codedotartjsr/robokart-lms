...
const schema = z.object({
  author: z
    .string()
    .min(3, { message: "Teacher name must be at least 3 charecters." })
    .max(30, { message: "The Teacher's name must not exceed 30 characters." }),
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
        <div className="flex flex-col gap-2">
          ...
          <Input
            type="text"
            {...register("author")}
            placeholder="Teacher name 3 to 8 charecters"
            className={cn("", {
